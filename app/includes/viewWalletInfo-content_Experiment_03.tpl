...
<section class="col-sm-8 view-wallet-content">
  ...
  <section class="row" ng-show='!showEnc'>
    ...
    <div class="col-sm-8 col-sm-offset-2">
      ...
      <br />
      <a tabindex="0" role="button" class="btn btn-primary btn-block" func="generateSingleWallet" ng-click="generateKeyStoreFile()" translate="NAV_GenerateWallet">Generate Wallet</a>
      <br /><br /><br /><br /><br /><br />
