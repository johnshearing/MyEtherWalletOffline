...
var viewWalletCtrl = function($scope, walletService) {
    ...
    /* Start of: Generate KeyStore File - third attempt */

    /* Commented out: Don't need to watch anything anymore.
    ...
    */
    ...
    /* Commented out: Moved validation into the generateKeyStoreFile function.
    ...
    */
    ...
    $scope.genWalletBlob = function() {
        if ($scope.isDone) {
            ...
            //blob never gets called. I don't think we need this next line.
            //$scope.blob = globalFuncs.getBlob("text/json;charset=UTF-8", $scope.wallet.toJSON());

            /* Commented out in favor of the line below.
    ...
    $scope.generateKeyStoreFile = function() 
    {
        ...
        //console.log($scope.finishedKeyStoreText);
        //console.log($scope.wallet.toV3($scope.newKeyStoreFilepassword, {kdf: globalFuncs.kdf, n: globalFuncs.scrypt.n}));         
        //console.log($scope.finishedKeyStoreFilename);
        //console.log($scope.wallet.getV3Filename());
    }

    /* End of: Generate KeyStore File - third attempt*/




    /* Start of: Generate KeyStore File - second failed attempt
    $scope.$watch(function() {
       ...
       End of: Generate KeyStore File - second failed attempt */
