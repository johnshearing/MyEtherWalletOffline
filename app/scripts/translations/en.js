...
x_Download                  : 'Download ',
x_GenerateKeyStoreButtonTxt : 'Generate KeyStore File ',
x_GenerateKeyStoreHelp      : 'Provide a password, then press this button to encrypt the private key and store the encrpted data in a KeyStore file which will be saved to the Download directory. Then you should be able to access your Ethereum account using the KeyStore file by supplying the password when prompted. After making the KeyStore file, be sure that it works and that you can actually use it to access the account for which you made it. You can test this by actually using the keystore file to move a small amount of ether out of the account for which the key was made. Do not fail to perform this test. Also, be sure to print out several hard copies of your private key and store these in several different safe locations in case of device failure, fire, theft, natural disaster, civil war, or if you forget the password to your keystore file. ',
x_GenerateKeyStoreFileLabel : 'Generate a KeyStore file ',
